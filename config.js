...
const CONFIG = {
            ...
            items: [
                {
                    ...
                    image: "https://res.cloudinary.com/dnytbujnc/image/upload/v1770207208/Screenshot_2026-02-04_081253_jvrbqv.png",
                    audioUrl: "" // Add custom audio URL here
                },
                {
                    title: "Best Marvel Rivals support",
                    image: "https://res.cloudinary.com/dnytbujnc/image/upload/v1770206760/206F4A1_r2pdm3.jpg",
                    audioUrl: "" // Add custom audio URL here
                },
                {
                    title: "Goated DBD player, the legendary Eden",
                    image: "https://res.cloudinary.com/dnytbujnc/video/upload/v1770212466/video_project_2_p9jdr0.mp4",
                    audioUrl: "https://res.cloudinary.com/dnytbujnc/video/upload/v1770215332/winter-soldier-again_mtjycs.mp3" // Add custom audio URL here
                },
                {
                    title: "Another Goated Eden move",
                    image: "https://res.cloudinary.com/dnytbujnc/video/upload/v1770211745/Video_Project_ni1yho.mp4",
                    audioUrl: "https://res.cloudinary.com/dnytbujnc/video/upload/v1770215332/winter-soldier-again_mtjycs.mp3" // Add custom audio URL here
                }
            ]
        },
    ...
    quiz: {
        ...
        questions: [
            ...
            {
                question: "What's my absolute favorite sound in the world?",
                options: ["Music", "Nature", "Your laugh/giggle", "Rain"],
                correct: 2,
                wrongResponses: [
                    "I mean I love music, but your giggle is literally the best thing ever! 🎶",
                    "Nature is peaceful, but your laugh is the best melody! 🌿",
                    null,
                    "Rain is cozy, but I'd rather hear you laughing! ☔"
                ],
                rightResponse: "Bingo! I could listen to you happy all day! 👂💕"
            },
            {
                question: "If I could teleport anywhere right now, where would I go?",
                options: ["The Moon", "Paris", "Right next to you", "Disney World"],
                correct: 2,
                wrongResponses: [
                    "The moon is cool, but being with you is much better! 🌙",
                    "Paris is romantic, but being with you is much better! 🗼",
                    null, // Correct answer
                    "Disney is magical, but being with you is a fairytale! 🏰"
                ],
                rightResponse: "In a heartbeat! Distance is just a number. ✈️💖"
            }
        ],
